...
Button(window, text="*",width=5, height =1, font=("Helvetica",25,""), borderwidth=1, foreground="#ffffff", background="#2a2d36",command =lambda: show("*")).place(x=355, y=100)
...
Button(window, text=".",width=5, height =1, font=("Helvetica",25,""), borderwidth=1, foreground="#ffffff", background="#2a2d36",command =lambda: show(".")).place(x=355, y=340)

Button(window, text="0",width=5, height =1, font=("Helvetica",25,""), borderwidth=1, foreground="#ffffff", background="#2a2d36",command =lambda: show("0")).place(x=10, y=420)
Button(window, text="(",width=5, height =1, font=("Helvetica",25,""), borderwidth=1, foreground="#ffffff", background="#2a2d36",command =lambda: show("(")).place(x=125, y=420)
...
Button(window, text="=",width=5, height =1, font=("Helvetica",25,""), borderwidth=1, foreground="#ffffff", background="#fe9037",command =lambda: calculate()).place(x=355, y=420)
window.mainloop()
